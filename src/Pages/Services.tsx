...
const Services = () => {
    return (
        ...
        >
            <section className=' px-5 bg-[#001B3A] '>
                {/* title */}
                <div className='max-w-7xl mx-auto'>
                    <div className='h-130 flex flex-col justify-center  '>
                        <div className='py-10'>
                            ...
                            <h1 className='text-3xl md:text-4xl lg:text-6xl font-extrabold md:w-150 pb-8 text-white '>Services built for modern products.</h1>
